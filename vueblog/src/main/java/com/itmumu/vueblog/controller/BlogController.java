...
import com.itmumu.vueblog.util.ShiroUtil;
 ...
 * @since 2020-08-05
 */
@RestController @RequestMapping("/") public class BlogController {
    @Autowired BlogService blogService;

    @GetMapping("/blogs") public Result list(@RequestParam(defaultValue = "1") Integer currentPage) {
     ...
     * @return
     */
    @GetMapping("/blog/{id}") public Result detail(@PathVariable(name = "id") Long id) {
